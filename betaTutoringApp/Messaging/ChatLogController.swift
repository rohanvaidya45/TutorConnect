...
//  betaTutoringApp
//
//  Created by Rahi Kotadia on 8/24/19.
...
class ChatLogController: UICollectionViewController, UITextFieldDelegate, UICollectionViewDelegateFlowLayout{
    ...
    private func setUpCell(cell: ChatMessageCell, message: Message){
        if message.fromID == Auth.auth().currentUser?.uid{
            cell.bubbleView.backgroundColor = UIColor(red: 0, green: 0, blue: 0.4, alpha: 0.7)
            cell.textView.textColor = .white
            cell.bubbleViewRightAnchor?.isActive = true
            cell.bubbleViewLeftAnchor?.isActive = false
        }else{
            cell.bubbleView.backgroundColor = UIColor(red: 0, green: 0.8, blue: 0.4, alpha: 0.7)
    ...
    func setUpInputComponents(){
        ...
        sendButton.backgroundColor = UIColor(red:0, green:0, blue: 0.5, alpha: 0);
